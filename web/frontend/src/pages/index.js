...
export default function Home() {
  ...
  const steps = {
    service: <SelectService onServiceSelect={handleServiceSelect} />,
    barber: (
      <ChooseBarber
    ...
    datetime: <DateTime onNext={handleDateTimeSelect} />,
    info: <Info onNext={handleInfoSubmit} />,
    payment: <PaymentInfo />,
    // Placeholder for the confirmation step
  ...
  return (
    <>
      <section className={styles.landing}>
        ...
        <button className={styles.bookNowButton} onClick={handleBookNowClick}>
          BOOK NOW
        </button>
      </section>
